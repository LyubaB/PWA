...
//        return driver.findElement(By.xpath("//*[@class='header-logo-2jr']"));
//    }
    ...
    public boolean isGrayFieldAroundPopup (){
        try{ wait.until(ExpectedConditions.invisibilityOf(getGrayFieldAroundPopup()));
    ...
    public boolean suggestionsExist (){
        try{ wait.until(ExpectedConditions.visibilityOf(getSuggestionsSearch()));
    ...
    public boolean popularBrandsExist (){
        try{wait.until(ExpectedConditions.visibilityOf(getPopularBrandsSearch()));
    ...
    public boolean topSuggestionsExist (){
        try{wait.until(ExpectedConditions.visibilityOf(getTopSuggestionsSearch()));
    ...
    public boolean sixthLineForSuggestionsSearchExist (){
        try{Thread.sleep(2000);
            ...
            logger.info("Sixth line for Suggestions search doesn't exist");
            return false;
        }
        return true;
    }
    public boolean sixthLineForPopularBrandsSearchExist (){
        try{Thread.sleep(2000);
            ...
            logger.info("Sixth line for Popular Brands search doesn't exist");
            return false;
        }
        return true;
    }
